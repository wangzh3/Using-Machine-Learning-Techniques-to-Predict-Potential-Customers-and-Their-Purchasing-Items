...
#user week1 hour1 week2 hour2 dw click item
def preprocess_click(logpath,savepath):
    label = np.loadtxt("/Users/adminadmin/Documents/mywork/e-commerce/yoochoose-data/yoochoose-buys.dat", dtype=np.str,
                       delimiter=",")
    print("load label")
...
def preprocess_sequence(logpath,savepath):
    ...
    file.close()
'''
logpath="/Users/adminadmin/Documents/mywork/e-commerce/yoochoose-data/yoochoose-clicks.dat"
savepath="/Users/adminadmin/Documents/mywork/e-commerce/yoochoose-data/yoochoose-clickssave.txt" #9248730
preprocess_click(logpath,savepath)

dataset = np.loadtxt(savepath, dtype=np.float)
print ("load data")
#shuffle training dataset
np.random.shuffle(dataset)
file=open("/Users/adminadmin/Documents/mywork/e-commerce/yoochoose-data/yoochoose-clickssave1.txt","w")
np.savetxt("/Users/adminadmin/Documents/mywork/e-commerce/yoochoose-data/yoochoose-clickssave1.txt",dataset)
file.close()

#transcation
logpath="/Users/adminadmin/Documents/mywork/e-commerce/yoochoose-data/yoochoose-buys.dat"
savepath="/Users/adminadmin/Documents/mywork/e-commerce/yoochoose-data/yoochoose-transaction.txt" #9248730
preprocess_transaction(logpath,savepath)

logpath="/Users/adminadmin/Documents/mywork/e-commerce/yoochoose-data/yoochoose-clicks.dat"
savepath="/Users/adminadmin/Documents/mywork/e-commerce/yoochoose-data/yoochoose-transaction-clicks.txt"
preprocess_transaction(logpath,savepath)

#sequence
logpath="/Users/adminadmin/Documents/mywork/e-commerce/yoochoose-data/yoochoose-clicks.dat"
savepath="/Users/adminadmin/Documents/mywork/e-commerce/yoochoose-data/yoochoose-sequence-clicks.txt"
preprocess_sequence(logpath,savepath)
'''
logpath="/Users/adminadmin/Documents/mywork/e-commerce/yoochoose-data/yoochoose-test.dat"
savepath="/Users/adminadmin/Documents/mywork/e-commerce/yoochoose-data/yoochoose-testsave.txt" #9248730
preprocess_click(logpath,savepath)
