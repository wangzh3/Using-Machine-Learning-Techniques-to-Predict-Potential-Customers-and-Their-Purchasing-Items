...
#load transaction
clicklist,userlist,num_transaction=load_transaction(root+"yoochoose-data/yoochoose-transaction-clicks.txt")
#load click sequence
clickseq,userlist,num_transaction=load_transaction(root+"yoochoose-data/yoochoose-sequence-clicks.txt")
#load bought users
buy_user=np.unique(np.loadtxt(root+"yoochoose-data/yoochoose-buys.dat",dtype=np.str, delimiter=",")[:,0])
print ("load data")
...
#Markov chain
file=open(root+"yoochoose-data/solution.txt","w")
num_user=0
...
#test
predict_item,buy_user_list,num_buy=load_transaction(root+"yoochoose-data/solution.txt")
buy_item,buy_user_list1,num_buy1=load_transaction(root+"yoochoose-data/yoochoose-transaction.txt")
